...
open class AnimatableButton: UIButton, CornerDesignable, FillDesignable, BorderDesignable, ShadowDesignable, MaskDesignable, Animatable {
  ...
  open var animationtouchesBegan: AnimationType = .none
  @IBInspectable var _animationtouchesBeganType: String? {
    didSet {
      animationtouchesBegan = AnimationType(string: _animationtouchesBeganType)
    }
  }
 /* open override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
    if case .none = animationtouchesBegan {
      super.touchesBegan(touches, with: event)
    } else {
      self.animate(animationtouchesBegan).completion {
          super.touchesBegan(touches, with: event)
      }
    }
  }*/
  ...
  override open func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
    super.touchesEnded(touches, with: event)
      ...
      ButtonAnimator.zoomOutIn.touchEndAnimation(self)
  ...
  override open func touchesCancelled(_ touches: Set<UITouch>, with event: UIEvent?) {
    ...
    ButtonAnimator.zoomOutIn.touchEndAnimation()
  }
...
enum ButtonAnimator {
  ...
  func touchStartAnimation(view: UIView, configuration: AnimationConfiguration) {
  ...
  func touchEndAnimation(view: UIView, configuration: AnimationConfiguration){
  UIView.animate(withDuration: configuration.duration,
  delay: configuration.delay,
  options: .curveEaseIn,
  animations: {() -> Void in
